...
namespace Server
{
    class Program
    {
        ...
        public static string GetLocalIP()
        {
            ...
            throw new Exception("IP Address Salah !!!");
        }
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Server dimulai pada " + GetLocalIP());

            TcpListener server = new TcpListener(IPAddress.Parse(GetLocalIP()), 1000);
            server.Start();
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    Console.WriteLine("Menerima Pesan Terenkripsi : " + msg + "\n");
                    Console.WriteLine("Pesan Terdekripsi : " + DecyrptRSA(msg) + "\n");

                }
                catch
                {
                    Console.WriteLine("- Menutup Server -");
                    break;
                }
